...
import 'package:kids_van/screens/admin_login.dart';
import 'package:kids_van/screens/admin_signup.dart';
...
class AdminAuth extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: const Text("Admin Auth", style: TextStyle(color: Colors.white),),
